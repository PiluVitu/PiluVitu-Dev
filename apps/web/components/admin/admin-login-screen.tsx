...
interface AdminLoginScreenProps {
  /** Dispara o login (default = fluxo real do Google via Better Auth). Override em stories/testes. */
 ...
 * deixar a área num beco sem saída. Componente puro (ação por prop).
 */
    ...
    <main className="grid min-h-screen place-items-center px-6">
      <div className="border-border bg-card shadow-ds w-full max-w-sm rounded-[var(--radius)] border p-8 text-center">
        ...
        <button
          ...
          onClick={handleClick}
          disabled={carregando}
          className="bg-primary text-primary-foreground rounded-pill mt-6 inline-flex items-center gap-2 px-5 py-2.5 text-sm font-medium disabled:opacity-60"
        >

  ...
  ;((__webpack_require__.m = __webpack_modules__),
    ...
    (__webpack_require__.l = (url, done, key, chunkId) => {
      if (inProgress[url]) inProgress[url].push(done)
        ...
        if (void 0 !== key)
          for (
            ...
            if (
              ...
              s.getAttribute('data-webpack') == 'piluvitu-dev:' + key
            ) {
              script = s
              break
            }
        ...
        ;(script ||
          ...
          script.setAttribute('data-webpack', 'piluvitu-dev:' + key),
          (script.src = url)),
          (inProgress[url] = [done]))
    ...
    (() => {
      ...
      var webpackJsonpCallback = (parentChunkLoadingFunction, data) => {
        ...
        chunkLoadingGlobal = (self.webpackChunkpiluvitu_dev =
          self.webpackChunkpiluvitu_dev || [])

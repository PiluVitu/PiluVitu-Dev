/*! For license information please see 577.8e56b600.iframe.bundle.js.LICENSE.txt */
'use strict'
;(self.webpackChunkpiluvitu_dev = self.webpackChunkpiluvitu_dev || []).push([
  [577],
  {
    './node_modules/.pnpm/@storybook+react-dom-shim@10.3.1_react-dom@19.2.4_react@19.2.4__react@19.2.4_storybook@_3eadab223dae091efb23c38ff290a2c5/node_modules/@storybook/react-dom-shim/dist/react-18.js'(
      ...
      var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(
          './node_modules/.pnpm/next@16.2.1_@babel+core@7.29.0_react-dom@19.2.4_react@19.2.4__react@19.2.4/node_modules/next/dist/compiled/react/index.js',
        ),
        react_dom_client__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
          './node_modules/.pnpm/next@16.2.1_@babel+core@7.29.0_react-dom@19.2.4_react@19.2.4__react@19.2.4/node_modules/next/dist/compiled/react-dom/client.js',
        ),
        nodes = new Map()
    ...
    './node_modules/.pnpm/next@16.2.1_@babel+core@7.29.0_react-dom@19.2.4_react@19.2.4__react@19.2.4/node_modules/next/dist/compiled/react-dom/cjs/react-dom-client.production.js'(
      __unused_webpack_module,
      exports,
      __webpack_require__,
    ) {
      var process = __webpack_require__(
        ...
        Scheduler = __webpack_require__(
          './node_modules/.pnpm/next@16.2.1_@babel+core@7.29.0_react-dom@19.2.4_react@19.2.4__react@19.2.4/node_modules/next/dist/compiled/scheduler/index.js',
        ),
        React = __webpack_require__(
          './node_modules/.pnpm/next@16.2.1_@babel+core@7.29.0_react-dom@19.2.4_react@19.2.4__react@19.2.4/node_modules/next/dist/compiled/react/index.js',
        ),
        ReactDOM = __webpack_require__(
          './node_modules/.pnpm/next@16.2.1_@babel+core@7.29.0_react-dom@19.2.4_react@19.2.4__react@19.2.4/node_modules/next/dist/compiled/react-dom/index.js',
        )
      ...
      function getNearestMountedFiber(fiber) {
        for (
          ...
          (!!(4098 & (node = nextNode).flags) && (fiber = node.return),
      ...
      function getActivityInstanceFromFiber(fiber) {
        if (31 === fiber.tag) {
          ...
          if (
            (null === activityState &&
              null !== (fiber = fiber.alternate) &&
              (activityState = fiber.memoizedState),
            null !== activityState)
          )
      ...
      function findNextSibling(child) {
        return ((searchTarget = child), !0)
      }
      function isFiberPrecedingCheck(child, target, boundary) {
        return (
          child === boundary ||
          (child === target && ((searchTarget = child), !0))
        )
      }
            ...
            ? 0 !== (pendingLanes = nonIdlePendingLanes & ~suspendedLanes)
              ...
              : 0 !== (pingedLanes &= nonIdlePendingLanes)
                ...
                : rootHasPendingCommit ||
                  (0 !== (rootHasPendingCommit = nonIdlePendingLanes & ~root) &&
      ...
      function getBumpedLaneForHydration(root, renderLanes) {
        ...
        return 0 !==
          ((renderLane =
            42 & renderLane ? 1 : getBumpedLaneForHydrationByLane(renderLane)) &
            (root.suspendedLanes | renderLanes))
          ? 0
          : renderLane
      }
      ...
      function pushMutationContext() {
        ...
        return ((viewTransitionMutationContext = !1), prev)
      }
      ...
      function track(node) {
        if (!node._valueTracker) {
          ...
          node._valueTracker = (function trackValueOnNode(
            node,
            valueField,
            currentValue,
          ) {
          ...
          })(node, valueField, '' + node[valueField])
        }
      }
            ...
            case 'input':
              if (
                ...
                for (
                  ...
                  (otherNode = props[internalInstance]).form === target.form &&
      ...
      var SyntheticKeyboardEvent = createSyntheticEvent(
        ...
        SyntheticSubmitEvent = createSyntheticEvent(
          assign({}, EventInterface, { submitter: 0 }),
        ),
      ...
      function getViewTransitionName(props, instance) {
        return null != props.name && 'auto' !== props.name
          ? props.name
          : null !== instance.autoName
            ? instance.autoName
            : ((props =
                '_' +
                (props = pendingEffectsRoot.identifierPrefix) +
                't_' +
                (globalClientIdCounter$1++).toString(32) +
                '_'),
              (instance.autoName = props))
      }
      ...
      function getViewTransitionClassName(defaultClass, eventClass) {
        return (
          ...
          null == (eventClass = getClassNameByType(eventClass))
            ? 'auto' === defaultClass
              ? null
              : defaultClass
            : 'auto' === eventClass
      ...
      function finishQueueingConcurrentUpdates() {
        for (
          ...
          if (
            ((concurrentQueues[i++] = null), null !== queue && null !== update)
          ) {
      ...
      function createWorkInProgress(current, pendingProps) {
        ...
        return (
          ...
          (workInProgress.flags = 133169152 & current.flags),
            ...
            case REACT_ACTIVITY_TYPE:
              return (
                ((type = createFiberImplClass(
                  ...
                  key,
                  mode,
                )).elementType = REACT_ACTIVITY_TYPE),
                (type.lanes = lanes),
                type
              )
            case REACT_FRAGMENT_TYPE:
            ...
            case REACT_VIEW_TRANSITION_TYPE:
              return (
                ((type = createFiberImplClass(
                  ...
                  key,
                  (type = 32 | mode),
                )).elementType = REACT_VIEW_TRANSITION_TYPE),
                (type.lanes = lanes),
                (type.stateNode = {
                  autoName: null,
                  paired: null,
      ...
      function popHydrationState(fiber) {
        ...
        if (
          ...
          if (
            !(fiber =
              null !== (fiber = fiber.memoizedState) ? fiber.dehydrated : null)
          )
          ...
          if (null !== list) {
            ...
            null === fiber.memoizedState.dehydrated
              ? ((fiber.lanes |= renderLanes),
                null !== (nextFiber = fiber.alternate) &&
                  (nextFiber.lanes |= renderLanes),
                scheduleContextWorkOnParentPath(
                  fiber.return,
                  renderLanes,
      ...
      function queueTransitionTypes(root, transitionTypes) {
        if (4194048 & root.pendingLanes) {
          var queued = root.transitionTypes
          for (
            null === queued && (queued = root.transitionTypes = []), root = 0;
            root < transitionTypes.length;
            root++
          ) {
            var transitionType = transitionTypes[root]
            ;-1 === queued.indexOf(transitionType) &&
      ...
      ReactSharedInternals.S = function (transition, returnValue) {
        ...
        if (null !== (root$27 = transition.types)) {
          ...
          if (0 !== currentEntangledLane) {
            null === (root$28 = entangledTransitionTypes) &&
              (root$28 = entangledTransitionTypes = [])
            for (var i = 0; i < root$27.length; i++) {
              var transitionType = root$27[i]
              ;-1 === root$28.indexOf(transitionType) &&
                root$28.push(transitionType)
            }
          }
        }
      ...
      function trackUsedThenable(thenableState, thenable, index) {
        switch (
          ...
          case 'rejected':
            throw (
              checkIfUseWrappedInAsyncCatch((thenableState = thenable.reason)),
              thenableState
            )
          default:
              ...
              return (function reconcileChildrenArray(
                ...
                for (
                  ...
                  null !==
                    ...
                    (shouldTrackSideEffects &&
                      null !== (newFiber = nextOldFiber.alternate) &&
                      oldFiber.delete(
              ...
              return (function reconcileChildrenIterator(
                ...
                for (
                  ...
                  null !==
                    ...
                    (shouldTrackSideEffects &&
                      null !== (nextOldFiber = step.alternate) &&
                      oldFiber.delete(
      ...
      function processUpdateQueue(
        ...
        if (null !== pendingQueue) {
          ...
          null !== current &&
            (pendingQueue = (current = current.updateQueue).lastBaseUpdate) !==
              lastBaseUpdate &&
            (null === pendingQueue
      ...
      function updateActionStateImpl(stateHook, currentStateHook, action) {
        ...
        var actionQueue = (currentStateHook = updateWorkInProgressHook()).queue,
      ...
      function updateEvent(callback) {
        ...
        return (
          ...
          })({ ref, nextImpl: callback }),
          function () {
            if (2 & executionContext) throw Error(formatProdErrorMessage(440))
      ...
      function mountDeferredValueImpl(hook, value, initialValue) {
        return void 0 === initialValue ||
          (1073741824 & renderLanes &&
            !(261930 & workInProgressRootRenderLanes))
          ...
          useSyncExternalStore: function (
            ...
            if (isHydrating) {
              ...
              if (
                ...
                throw Error(formatProdErrorMessage(349))
              127 & workInProgressRootRenderLanes ||
                pushStoreConsistencyCheck(fiber, getSnapshot, getServerSnapshot)
            }
      ...
      function resolveClassComponentProps(Component, baseProps) {
        ...
        if ((Component = Component.defaultProps))
          for (var propName$76 in (newProps === baseProps &&
      ...
      function updateSuspenseComponent(current, workInProgress, renderLanes) {
            ...
            if (
              ...
              (current = nextHydratableInstance)
                ? null !==
                  ...
                  ((renderLanes =
                    createFiberFromDehydratedFragment(current)).return =
                    workInProgress),
        ...
        if (
          null !== prevState &&
          null !== (nextPrimaryChildren = prevState.dehydrated)
        ) {
          if (didSuspend)
        ...
        return showFallback
          ? (reuseSuspenseHandlerOnStack(),
            (nextPrimaryChildren = nextProps.fallback),
            (showFallback = workInProgress.mode),
            (digest = (prevState = current.child).sibling),
            ((nextProps = createWorkInProgress(prevState, {
              mode: 'hidden',
              children: nextProps.children,
            })).subtreeFlags = 133169152 & prevState.subtreeFlags),
            null !== digest
            ...
            null === (nextPrimaryChildren = current.child.memoizedState)
              ? (nextPrimaryChildren = mountSuspenseOffscreenState(renderLanes))
              : (null !== (showFallback = nextPrimaryChildren.cachePool)
      ...
      function mountWorkInProgressOffscreenFiber(offscreenProps, mode) {
        return (
          ((offscreenProps = createFiberImplClass(
            22,
            offscreenProps,
            null,
            mode,
      ...
      function reverseChildren(fiber) {
        ...
        for (fiber.child = null; null !== row; ) {
          ...
          ;((row.sibling = fiber.child), (fiber.child = row), (row = nextRow))
        }
      }
      function updateSuspenseListComponent(
        ...
        if (128 & workInProgress.flags)
          return (pushSuspenseListContext(0, suspenseContext), null)
        var shouldForceFallback = !!(2 & suspenseContext)
        if (
          (shouldForceFallback
            ? ((suspenseContext = (1 & suspenseContext) | 2),
              (workInProgress.flags |= 128))
            : (suspenseContext &= 1),
          pushSuspenseListContext(0, suspenseContext),
          ...
          !shouldForceFallback && null !== current && 128 & current.flags)
        )
        ...
        switch (revealOrder) {
          case 'backwards':
            ;(null === (renderLanes = findLastContentRow(workInProgress.child))
      ...
      function updateContextProvider(current, workInProgress, renderLanes) {
        ...
        return (
          pushProvider(0, workInProgress.type, newProps.value),
          reconcileChildren(
            current,
            workInProgress,
            newProps.children,
                  ...
                  switch (workInProgress.tag) {
                    ...
                    case 13:
                      ...
                      if (null !== state$107) {
                        ...
                        return state$107 ||
                          0 !== (renderLanes & primaryChildLanes)
                    ...
                    case 19:
                      ...
                      if (
                        ((primaryChildLanes = !!(128 & current.flags)),
                        (state$107 =
                          0 !== (renderLanes & workInProgress.childLanes)) ||
                          (propagateParentContextChanges(
                            current,
                      ...
                      if (
                        ...
                        pushSuspenseListContext(0, suspenseStackCursor.current),
                        state$107)
                      )
                        break
                      return null
        ...
        switch (((workInProgress.lanes = 0), workInProgress.tag)) {
          case 16:
            a: {
              ...
              if (
                ...
                throw (
                  (workInProgress =
                    getComponentNameFromType(current) || current),
          ...
          case 5:
            return (
              null === current &&
                isHydrating &&
                (($$typeof = props = nextHydratableInstance) &&
                  (null !==
                  (props = (function canHydrateInstance(
                    instance,
                    type,
                    props,
                    inRootOrSingleton,
          ...
          case 9:
            return (
              ...
              prepareToReadContext(workInProgress),
              (props = props(($$typeof = readContext($$typeof)))),
              (workInProgress.flags |= 1),
              reconcileChildren(current, workInProgress, props, renderLanes),
              workInProgress.child
            )
          ...
          case 31:
            return (function updateActivityComponent(
              current,
              workInProgress,
              renderLanes,
            ) {
              var nextProps = workInProgress.pendingProps,
                didSuspend = !!(128 & workInProgress.flags)
              if (((workInProgress.flags &= -129), null === current)) {
                if (isHydrating) {
                  ...
                  if (
                    ...
                    throw throwOnHydrationMismatch(workInProgress)
                  return ((workInProgress.lanes = 536870912), null)
                }
              ...
              if (null !== prevState) {
                ...
                if (
                  ...
                  if (
                    null !== (nextProps = workInProgressRoot) &&
                    0 !==
                      (dehydrated = getBumpedLaneForHydration(
                        nextProps,
                        renderLanes,
                      )) &&
                    dehydrated !== prevState.retryLane
                  )
                    throw (
            ...
            return (
              ...
              null === current
                ? (null === ($$typeof = peekCacheFromPool()) &&
                  ...
                  initializeUpdateQueue(workInProgress),
                  pushProvider(0, CacheContext, $$typeof))
                : (0 !== (current.lanes & renderLanes) &&
                    (cloneUpdateQueue(current, workInProgress),
          ...
          case 30:
            return (
              ...
              null != (props = workInProgress.pendingProps).name &&
              'auto' !== props.name
      ...
      function preloadInstanceAndSuspendIfNeeded(
        ...
        var JSCompiler_temp
        if (
          ((JSCompiler_temp = !!(32 & workInProgress.mode)) &&
            (JSCompiler_temp =
              null === oldProps
          ...
          if (
            ...
            (335544128 & renderLanes) === renderLanes)
          )
      ...
      function cutOffTailIfNeeded(renderState, hasRenderedATailFallback) {
        if (!isHydrating)
          switch (renderState.tailMode) {
            ...
            default:
              for (
                hasRenderedATailFallback = renderState.tail, tailNode = null;
        ...
        if (didBailout)
          for (var child$112 = completedWork.child; null !== child$112; )
            ((newChildLanes |= child$112.lanes | child$112.childLanes),
              (subtreeFlags |= 133169152 & child$112.subtreeFlags),
              (subtreeFlags |= 133169152 & child$112.flags),
        ...
        switch ((popTreeContext(workInProgress), workInProgress.tag)) {
              ...
              null === current
                ...
                : nextResource
                  ? nextResource !== current.memoizedState
                    ...
                    : (bubbleProperties(workInProgress),
                      (workInProgress.flags &= -16777217))
                  : ((current = current.memoizedProps) !== newProps &&
                      markUpdate(workInProgress),
                    bubbleProperties(workInProgress),
                    preloadInstanceAndSuspendIfNeeded(
                      workInProgress,
                ...
                switch (nextResource) {
                  ...
                  default:
                    switch (type) {
                      ...
                      case 'script':
                        ;(((nextResource =
                          ownerDocument.createElement('div')).innerHTML =
                          '<script><\/script>'),
                ...
                if (null === current) {
                  ...
                  (resetHydrationState(),
                    !(128 & workInProgress.flags) &&
                      (workInProgress.memoizedState = null),
                    (workInProgress.flags |= 4))
                ;(bubbleProperties(workInProgress), (current = !1))
              } else
          ...
          case 13:
            ...
            return (
              popSuspenseHandler(workInProgress),
              128 & workInProgress.flags
                ? ((workInProgress.lanes = renderLanes), workInProgress)
          ...
          case 19:
            if (
              ...
              null === (newProps = workInProgress.memoizedState))
            )
              return (bubbleProperties(workInProgress), null)
            if (
              ((type = !!(128 & workInProgress.flags)),
              null === (nextResource = newProps.rendering))
            )
              if (type) cutOffTailIfNeeded(newProps, !1)
                ...
                if (
                  ...
                  for (current = workInProgress.child; null !== current; ) {
                    if (null !== (nextResource = findFirstSuspended(current))) {
                      for (
                        workInProgress.flags |= 128,
              ...
              if (!type)
                if (null !== (current = findFirstSuspended(nextResource))) {
                  if (
                    ((workInProgress.flags |= 128),
                    (type = !0),
                    (current = current.updateQueue),
            ...
            if (null !== newProps.tail) {
              a: {
                for (
                  renderLanes = current = newProps.tail;
                  null !== renderLanes;
                ) {
              ...
              return (
                ...
                !renderLanes ||
                isHydrating
                  ? pushSuspenseListContext(0, nextResource)
          ...
          if (null !== ref) {
            switch (current.tag) {
              ...
              case 30:
                ...
                ;((null !== instance.ref && instance.ref.name === name) ||
        ...
        try {
          ...
          ;(!(function updateProperties(domElement, tag, lastProps, nextProps) {
            switch (tag) {
              ...
              case 'textarea':
                for (defaultValue in ((propKey = propKey$215 = null),
                lastProps))
                  if (
                ...
                return void updateTextarea(domElement, propKey$215, propKey)
              case 'option':
                for (var propKey$231 in lastProps)
                  if (
                    ...
                    if ('selected' === propKey$231) domElement.selected = !1
                    else
                      setProp(
                        domElement,
                        tag,
      ...
      function commitNewChildToFragmentInstances(
        fiber,
      ...
      function trackEnterViewTransitions(placement) {
        ;(30 === placement.tag || 33554432 & placement.subtreeFlags) &&
      ...
      function pushViewTransitionCancelableScope() {
        ...
        return ((viewTransitionCancelableChildren = null), prevChildren)
      }
        ...
        for (var inViewport = !1; null !== child; ) {
          if (5 === child.tag) {
            ...
            if (null !== collectMeasurements) {
              ...
              inViewport ||
                (measureInstance(instance).view && (inViewport = !0))
            ;((shouldStartViewTransition = !0),
      ...
      function commitAppearingPairViewTransitions(placement) {
        if (18874368 & placement.subtreeFlags)
          for (placement = placement.child; null !== placement; ) {
            if (
              (22 !== placement.tag || null === placement.memoizedState) &&
              (commitAppearingPairViewTransitions(placement),
              30 === placement.tag &&
                18874368 & placement.flags &&
        ...
        if (30 === placement.tag) {
          ...
          'none' !== className
            ? applyViewTransitionToHostInstances(
              ...
              : restoreViewTransitionOnHostInstances(placement.child, !1)
            : commitAppearingPairViewTransitions(placement)
        } else if (33554432 & placement.subtreeFlags)
          for (placement = placement.child; null !== placement; )
      ...
      function commitExitViewTransitions(deletion) {
        if (30 === deletion.tag) {
          ...
          ;('none' !== className &&
            ...
            null !== appearingViewTransitions &&
              commitDeletedPairViewTransitions(deletion))
        } else if (33554432 & deletion.subtreeFlags)
          for (deletion = deletion.child; null !== deletion; )
      ...
      function commitNestedViewTransitions(changedParent) {
        for (changedParent = changedParent.child; null !== changedParent; ) {
          if (30 === changedParent.tag) {
            ...
            33554432 & changedParent.subtreeFlags &&
              commitNestedViewTransitions(changedParent)
          changedParent = changedParent.sibling
        }
      }
      function restorePairedViewTransitions(parent) {
        if (18874368 & parent.subtreeFlags)
          for (parent = parent.child; null !== parent; ) {
            if (22 !== parent.tag || null === parent.memoizedState) {
              if (30 === parent.tag && 18874368 & parent.flags) {
      ...
      function restoreEnterOrExitViewTransitions(fiber) {
        ...
        else if (33554432 & fiber.subtreeFlags)
        ...
        for (var inViewport = !1; null !== child; ) {
          if (5 === child.tag) {
            ...
            if (
              ...
              if (
                ((previousMeasurement.view || nextMeasurement.view) &&
                  (inViewport = !0),
                (JSCompiler_temp = !(4 & parentViewTransition.flags)))
              )
            ...
            ;(4 & parentViewTransition.flags &&
              ...
              (inViewport && 4 & parentViewTransition.flags) ||
            ...
            (22 === child.tag && null !== child.memoizedState) ||
              (30 === child.tag && stopAtNestedViewTransitions
                ? (parentViewTransition.flags |= 32 & child.flags)
          ...
          if (30 === changedParent.tag) {
            ...
            if (gesture)
              var previousMeasurements =
                null === (state = state.clones)
                  ? null
                  : state.map(measureClonedInstance)
            else
          ...
          switch (fiber.tag) {
            ...
            case 15:
              if (
                ...
                null !==
                  (current =
                    null !== (current = fiber.updateQueue)
                      ? current.events
                      : null)
              )
                for (
                  ...
                  (flags = current[isViewTransitionEligible]).ref.impl =
                    flags.nextImpl
              break
            case 1:
              if (1024 & flags && null !== current) {
              ...
              if (1024 & flags)
                if (
                  ...
                  (isViewTransitionEligible = (current =
                    fiber.stateNode.containerInfo).nodeType)
                )
            ...
            case 30:
              isViewTransitionEligible &&
                ...
                'none' !==
                  (flags = getViewTransitionClassName(
                    (flags = fiber.memoizedProps).default,
                    flags.update,
                  )) &&
                  applyViewTransitionToHostInstances(
                    current,
              ...
              break
            default:
              if (1024 & flags) throw Error(formatProdErrorMessage(163))
          }
      ...
      function commitLayoutEffectOnFiber(finishedRoot, current, finishedWork) {
        ...
        switch (finishedWork.tag) {
          ...
          case 3:
            if (
              (recursivelyTraverseLayoutEffects(finishedRoot, finishedWork),
              64 & flags && null !== (finishedRoot = finishedWork.updateQueue))
            ) {
          ...
          case 13:
            ;(recursivelyTraverseLayoutEffects(finishedRoot, finishedWork),
              ...
              64 & flags &&
                null !== (finishedRoot = finishedWork.memoizedState) &&
      ...
      function hideOrUnhideAllChildrenOnFiber(fiber, isHidden) {
        switch (fiber.tag) {
            ...
            try {
              ...
              if (isHidden) {
                ...
                var instance$jscomp$0 = fiber.stateNode,
                  ...
                  display =
                    null != styleProp && styleProp.hasOwnProperty('display')
                      ? styleProp.display
                      : null
          ...
          case 6:
            try {
              ;((fiber.stateNode.nodeValue = isHidden
                ? ''
                : fiber.memoizedProps),
                (viewTransitionMutationContext = !0))
            } catch (error) {
      ...
      function hideOrUnhideNearestPortals(parentFiber, isHidden$jscomp$0) {
        if (67108864 & parentFiber.subtreeFlags)
          for (parentFiber = parentFiber.child; null !== parentFiber; ) {
            a: {
        ...
        if (null !== deletions)
          for (var i = 0; i < deletions.length; i++) {
            ...
            ;(commitDeletionEffectsOnFiber(root, returnFiber, childToDelete),
              (hostParent = null),
              (hostParentIsContainer = !1),
              null !== (root = childToDelete.alternate) && (root.return = null),
              (childToDelete.return = null))
          }
        if (13886 & parentFiber.subtreeFlags)
          for (parentFiber = parentFiber.child; null !== parentFiber; )
        ...
        switch (finishedWork.tag) {
          ...
          case 1:
            ;(recursivelyTraverseMutationEffects(root, finishedWork, lanes),
              ...
              64 & flags &&
                ...
                null !== (current = finishedWork.callbacks) &&
                  ...
                  if (null === finishedWork.stateNode) {
                    a: {
                      ...
                      b: switch (current) {
                        case 'title':
                          ;((!(flags =
                            lanes.getElementsByTagName('title')[0]) ||
                        ...
                        case 'link':
                          if (
                            ...
                            for (var i = 0; i < hoistableRoot.length; i++)
                              if (
                                (flags = hoistableRoot[i]).getAttribute(
                                  'href',
                                ) ===
          ...
          case 31:
            ;(recursivelyTraverseMutationEffects(root, finishedWork, lanes),
              commitReconciliationEffects(finishedWork),
              4 & flags &&
                null !== (current = finishedWork.updateQueue) &&
          ...
          case 22:
            ...
            var prevOffscreenSubtreeIsHidden = offscreenSubtreeIsHidden,
              ...
              prevOffscreenDirectParentIsHidden$163 =
            ...
            ;((offscreenSubtreeIsHidden =
              ...
              commitReconciliationEffects(finishedWork),
              8192 & flags &&
                (((root = finishedWork.stateNode)._visibility = hoistableRoot
                  ? -2 & root._visibility
                  : 1 | root._visibility),
                hoistableRoot &&
                  (null === current ||
      ...
      function recursivelyTraverseAfterMutationEffects(root, parentFiber) {
        if (9270 & parentFiber.subtreeFlags)
          for (parentFiber = parentFiber.child; null !== parentFiber; )
          ...
          switch (finishedWork.tag) {
            case 3:
              if (
                ...
                !viewTransitionContextChanged && !rootViewTransitionAffected)
              ) {
                if (null !== (finishedWork = viewTransitionCancelableChildren))
                ...
                ;(null !==
                  (finishedWork =
                    9 === (finishedWork = root.containerInfo).nodeType
      ...
      function recursivelyTraverseReappearLayoutEffects(
        ...
        for (
          includeWorkInProgressEffects =
            includeWorkInProgressEffects && !!(8772 & parentFiber.subtreeFlags),
          ...
          switch (finishedWork.tag) {
            ...
            case 5:
              if (5 === finishedWork.tag)
                for (
                  var parent = (instance = finishedWork).return;
                  null !== parent &&
      ...
      function recursivelyTraversePassiveMountEffects(
        ...
        var isViewTransitionEligible =
          (335544064 & committedLanes) === committedLanes
        if (
      ...
      function commitPassiveMountOnFiber(
        ...
        switch (finishedWork.tag) {
          ...
          case 3:
            ;(recursivelyTraversePassiveMountEffects(
              ...
              isViewTransitionEligible &&
                ...
                ('root' ===
                  (finishedRoot =
                    9 === (finishedRoot = finishedRoot.containerInfo).nodeType
                      ? finishedRoot.body
                      : 'HTML' === finishedRoot.nodeName
                        ? finishedRoot.ownerDocument.body
              ...
              2048 & flags &&
                ...
                (finishedWork = finishedWork.memoizedState.cache) !== flags &&
            ...
            ;((_finishedWork$memoize2 = finishedWork.stateNode),
              ...
              null !== finishedWork.memoizedState
                ? (isViewTransitionEligible &&
                  ...
                  2 & _finishedWork$memoize2._visibility
                    ? recursivelyTraversePassiveMountEffects(
                        finishedRoot,
                        finishedWork,
                        committedLanes,
                  ...
                  2 & _finishedWork$memoize2._visibility
                    ...
                    : ((_finishedWork$memoize2._visibility |= 2),
                      recursivelyTraverseReconnectPassiveEffects(
                        ...
                        committedLanes,
                        committedTransitions,
                        !!(10256 & finishedWork.subtreeFlags) || !1,
                      ))),
              2048 & flags &&
          ...
          case 30:
            ;(isViewTransitionEligible &&
              null !== (flags = finishedWork.alternate) &&
      ...
      function recursivelyTraverseReconnectPassiveEffects(
        ...
        for (
          includeWorkInProgressEffects =
            includeWorkInProgressEffects &&
            (!!(10256 & parentFiber.subtreeFlags) || !1),
            parentFiber = parentFiber.child;
          null !== parentFiber;
        ) {
        ...
        switch (fiber.tag) {
            ...
            ;(recursivelyAccumulateSuspenseyCommit(
              ...
              fiber.flags & suspenseyCommitFlag &&
                (null !== fiber.memoizedState
                  ...
                  : ((fiber = fiber.stateNode),
                    (335544128 & committedLanes) === committedLanes &&
          ...
          case 30:
            if (
              ...
              null != (previousHoistableRoot = fiber.memoizedProps.name) &&
              'auto' !== previousHoistableRoot
            ) {
        ...
        for (parentFiber = parentFiber.child; null !== parentFiber; ) {
          switch ((deletions = parentFiber).tag) {
            ...
            case 15:
              ...
              break
            case 22:
              2 & (i = deletions.stateNode)._visibility &&
                ((i._visibility &= -3),
                recursivelyTraverseDisconnectPassiveEffects(deletions))
              break
            default:
      ...
      function requestUpdateLane() {
        return 2 & executionContext && 0 !== workInProgressRootRenderLanes
      ...
      function requestDeferredLane() {
        if (0 === workInProgressDeferredLane)
          if (536870912 & workInProgressRootRenderLanes && !isHydrating)
            workInProgressDeferredLane = 536870912
          else {
            var lane = nextTransitionDeferredLane
            ;(!(3932160 & (nextTransitionDeferredLane <<= 1)) &&
              (nextTransitionDeferredLane = 262144),
              (workInProgressDeferredLane = lane))
          }
        return (
          null !== (lane = suspenseHandlerStackCursor.current) &&
            (lane.flags |= 32),
      ...
      function completeRootWhenReady(
        ...
        var subtreeFlags = finishedWork.subtreeFlags,
          isViewTransitionEligible = (335544064 & lanes) === lanes
        if (
          ((suspendedCommitReason = null),
          (isViewTransitionEligible ||
            8192 & subtreeFlags ||
            !(16785408 & ~subtreeFlags)) &&
            ((appearingViewTransitions = null),
            accumulateSuspenseyCommitOnFiber(
              finishedWork,
              lanes,
            ...
            isViewTransitionEligible &&
              ...
              null !=
                (isViewTransitionEligible = (
                  9 === (isViewTransitionEligible = root.containerInfo).nodeType
                    ? isViewTransitionEligible
            ...
            null !==
              (subtreeFlags = (function waitForCommitToBeReady(
                state,
                timeoutOffset,
              ) {
                return (
                  ...
                  0 < state.count || 0 < state.imgCount
                    ? function (commit) {
                          ...
                          (estimatedBytesWithinLimit =
                            ...
                            (function estimateBandwidth() {
                                ...
                                for (
                                  ...
                                  if (
                                    ...
                                    for (
                                      ...
                                      var overlapTransferSize =
                                          overlapEntry.transferSize,
                                        overlapInitiatorType =
                                          overlapEntry.initiatorType
                                      overlapTransferSize &&
                                        ...
                                        (initiatorType +=
                                          overlapTransferSize *
                                          ((overlapEntry =
                                            overlapEntry.responseEnd) < duration
                                            ? 1
                              ...
                              return navigator.connection &&
                                'number' ==
                                  typeof (count = navigator.connection.downlink)
                                ? count
                                : 5
                            })())
      ...
      function flushSyncWork$1() {
        return (
          !!(6 & executionContext) || (flushSyncWorkAcrossRoots_impl(0, !1), !1)
        )
      }
                      ...
                      return (
                        ...
                        value === noopSuspenseyCommitThenable
                          ...
                          : (null === (returnFiber = sourceFiber.updateQueue)
                              ...
                              : null === (sourceFiber = returnFiber.retryQueue)
          ...
          ;(root === workInProgressRoot &&
            ...
            (function commitRoot(
              ...
              if (
                ...
                (spawnedLane = !!(13878 & finishedWork.flags)),
                !!(13878 & finishedWork.subtreeFlags) || spawnedLane)
              ) {
                  ...
                  !(function commitBeforeMutationEffects(
                    ...
                    for (
                      ...
                      if (
                        ((root = nextEffect),
                        committedLanes &&
                          null !== (JSCompiler_temp = root.deletions))
                      )
                        for (
                          anchorOffset = 0;
                      ...
                      if (null === root.alternate && 2 & root.flags)
                        ...
                        ;((JSCompiler_temp = root.child),
                          0 !== (root.subtreeFlags & firstChild) &&
                          null !== JSCompiler_temp
                            ? ((JSCompiler_temp.return = root),
                              (nextEffect = JSCompiler_temp))
                            : (committedLanes &&
                                commitNestedViewTransitions(root),
                              commitBeforeMutationEffects_complete(
                                committedLanes,
                              )))
                      }
              ...
              ;((pendingEffectsStatus = 1),
                shouldStartViewTransition
                  ? (pendingViewTransition = (function startViewTransition(
                      suspendedState,
                      rootContainer,
                      transitionTypes,
                      mutationCallback,
                        ...
                        var transition = ownerDocument.startViewTransition({
                          update: function () {
                            var ownerWindow = ownerDocument.defaultView,
                              pendingNavigation =
                                ownerWindow.navigation &&
                                ownerWindow.navigation.transition,
                            ...
                            if (
                              ...
                              (previousFontLoadingStatus =
                                blockingPromises.length),
                              null !== suspendedState)
                            )
                              for (
                                var suspenseyImages =
                                    suspendedState.suspenseyImages,
                                  imgBytes = 0,
                                  i = 0;
                                ...
                                if (!suspenseyImage.complete) {
                                  var rect =
                                    suspenseyImage.getBoundingClientRect()
                                  if (
                                    0 < rect.bottom &&
                                    0 < rect.right &&
                                    ...
                                    if (
                                      (imgBytes +=
                                        estimateImageBytes(suspenseyImage)) >
                                      estimatedBytesWithinLimit
                                    ) {
                                      blockingPromises.length =
                                        previousFontLoadingStatus
                            ...
                            return 0 < blockingPromises.length
                              ...
                              : (layoutCallback(),
                                pendingNavigation
                                  ? pendingNavigation.finished.then(
                                      afterMutationCallback,
                                      afterMutationCallback,
                                    )
                                  : void afterMutationCallback())
                          },
                        ...
                        return (
                          transition.ready.then(
                            function () {
                              for (
                                var animations =
                                    ownerDocument.documentElement.getAnimations(
                                      { subtree: !0 },
                                    ),
                                  i = 0;
                                i < animations.length;
                                ...
                                if (
                                  ...
                                  for (
                                    ...
                                    if (
                                      ((w = keyframe.height), void 0 === height)
                                    )
                                      height = w
                                    else if (height !== w) {
                                      unchangedDimensions = !1
                                  ...
                                  unchangedDimensions &&
                                    ...
                                    (((unchangedDimensions =
                                      animation[0]).width = pseudoElement),
                                    (unchangedDimensions.height = height),
                                    ((unchangedDimensions =
                                      animation[animation.length - 1]).width =
                                      pseudoElement),
                                    (unchangedDimensions.height = height),
                                    effect.setKeyframes(animation))
                                }
                            ...
                            function (error) {
                              ownerDocument.__reactViewTransition ===
                                transition &&
                          ...
                          transition.finished.finally(function () {
                            for (
                              var i = 0;
                              i < viewTransitionAnimations.length;
                              i++
                            )
      ...
      function reportViewTransitionError(error) {
        0 !== pendingEffectsStatus &&
          (0, pendingEffectsRoot.onRecoverableError)(error, {
            componentStack: null,
          })
      }
      ...
      function flushSpawnedWork() {
        if (4 === pendingEffectsStatus || 3 === pendingEffectsStatus) {
          ...
          ;((pendingViewTransition = null), requestPaint())
          var root = pendingEffectsRoot,
            finishedWork = pendingFinishedWork,
            lanes = pendingEffectsLanes,
            recoverableErrors = pendingRecoverableErrors,
            passiveSubtreeMask = (335544064 & lanes) === lanes ? 10262 : 10256
          if (
            ...
            0 === (passiveSubtreeMask = root.pendingLanes) &&
              (legacyErrorBoundariesThatAlreadyFailed = null),
            lanesToEventPriority(lanes),
            (finishedWork = finishedWork.stateNode),
            injectedHook && 'function' == typeof injectedHook.onCommitFiberRoot)
          )
            try {
          ...
          if (
            ...
            (pendingTransitionTypes = null),
            null !== (recoverableErrors = pendingViewTransitionEvents) &&
              ((pendingViewTransitionEvents = null),
          ...
          ;(3 & pendingEffectsLanes && flushPendingEffects(),
            ...
            261930 & lanes && 42 & passiveSubtreeMask
      ...
      function flushSyncWorkAcrossRoots_impl(syncTransitionLanes, onlyLegacy) {
        if (!isFlushingWork && mightHavePendingSyncWork) {
          ...
          do {
            for (
              var didPerformSomeWork = !1, root$184 = firstScheduledRoot;
              null !== root$184;
            ) {
              if (!onlyLegacy)
      ...
      function requestTransitionLane() {
        if (0 === currentEventTransitionLane) {
          ...
          ;(0 === actionScopeLane &&
            ...
            !(261888 & (nextTransitionUpdateLane <<= 1)) &&
      ...
      function setProp(domElement, tag, key, value, props, prevValue) {
        switch (key) {
          ...
          case 'height':
            ...
            break
          case 'style':
            return void setValueForStyles(domElement, value, prevValue)
          case 'data':
            if ('object' !== tag) {
          ...
          case 'formAction':
            ...
            break
          case 'onClick':
            return void (null != value && (domElement.onclick = noop$1))
          case 'onScroll':
            return void (
      ...
      function setInitialProperties(domElement, tag, props) {
        switch (tag) {
          ...
          case 'select':
            for (hasSrcSet in (listenToNonDelegatedEvent('invalid', domElement),
          ...
          case 'textarea':
            for (propValue in (listenToNonDelegatedEvent('invalid', domElement),
            ...
            return void initTextarea(domElement, hasSrc, hasSrcSet, propKey)
          case 'option':
            ...
            if (isCustomElement(tag)) {
              for (propValue$198 in props)
                props.hasOwnProperty(propValue$198) &&
                  void 0 !== (hasSrc = props[propValue$198]) &&
                  setPropOnCustomElement(
                    domElement,
                    tag,
                    propValue$198,
            ...
            if ('/$' === (node = nextNode.data) || '/&' === node) {
              if (0 === depth)
                return (
                  ...
                  void retryIfBlockedOn(hydrationInstance)
                )
              depth--
            } else if (
              '$' === node ||
        ...
        if (
          ((name =
            CSS.escape(name) !== name
              ? 'r-' + btoa(name).replace(/=/g, '')
              : name),
          (instance.style.viewTransitionName = name),
          null != className && (instance.style.viewTransitionClass = className),
          'inline' === (className = getComputedStyle(instance)).display)
        ) {
          if (1 === (name = instance.getClientRects()).length)
          ...
          1 === JSCompiler_inline_result &&
            (((instance = instance.style).display =
              1 === name.length ? 'inline-block' : 'block'),
              ...
              : ((viewTransitionName = props.display),
                (instance.display =
                  ...
                  'boolean' == typeof viewTransitionName
                    ? ''
                    : viewTransitionName),
                null != (viewTransitionName = props.margin)
                  ...
                  : ((viewTransitionName = props.hasOwnProperty('marginTop')
                    ...
                    (instance.marginBottom =
                      null == props || 'boolean' == typeof props
                        ? ''
                        : props)))))
      }
          ...
          (function setFocusIfFocusable(node, focusOptions) {
            ...
            try {
              ;(node.ownerDocument.addEventListener('focus', handleFocus, !0),
                (node.focus || HTMLElement.prototype.focus).call(
                  node,
                  focusOptions,
                ))
            } finally {
            ...
            return didFocus
          })((fiber = getInstanceFromHostFiber(fiber)), focusOptions)
        )
      }
      function collectChildren(child, collection) {
        return (collection.push(child), !1)
      }
      function blurActiveElementWithinFragment(child, activeElement) {
        return (
          6 !== child.tag &&
          (child = getInstanceFromHostFiber(child)) === activeElement &&
          (child.blur(), !0)
        )
      }
      ...
      function collectClientRects(child, rects) {
        if (6 === child.tag) {
          var range = (child = child.stateNode).ownerDocument.createRange()
      ...
      function addFragmentHandleToFiber(child, fragmentInstance) {
        return (
          null != (child = getInstanceFromHostFiber(child)) &&
      ...
      function commitNewChildToFragmentInstance(
        childInstance,
        fragmentInstance,
      ) {
        if (3 !== childInstance.nodeType) {
      ...
      ;((ViewTransitionPseudoElement.prototype.animate = function (
        ...
        return (
          ((options =
            'number' == typeof options
              ? { duration: options }
              : assign({}, options)).pseudoElement = this._selector),
          this._scope.animate(keyframes, options)
        )
      }),
        ...
        (FragmentInstance.prototype.removeEventListener = function (
          ...
          null != listeners &&
            ...
            null !== this._eventListeners &&
              this._eventListeners.splice(type, 1))
        }),
        (FragmentInstance.prototype.dispatchEvent = function (event) {
          ...
          if (
            ...
            return (parentHostFiber.removeChild(temp), event)
          }
        ...
        (FragmentInstance.prototype.blur = function () {
          ...
          if (null !== parentHostFiber) {
            var activeElement = (parentHostFiber =
              getInstanceFromHostFiber(parentHostFiber)).ownerDocument
              .activeElement
            null !== activeElement &&
        ...
        (FragmentInstance.prototype.compareDocumentPosition = function (
          ...
          ;((parentHostFiber = getInstanceFromHostFiber(children[0])),
            (parentResult = getInstanceFromHostFiber(
          ...
          return (
            ...
            (parentHostFiber =
              ...
              lastResult
                ...
                : (!parentHostInstance && parentHostFiber === otherNode) ||
                  ...
                  : parent) & Node.DOCUMENT_POSITION_DISCONNECTED ||
            parentHostFiber & Node.DOCUMENT_POSITION_IMPLEMENTATION_SPECIFIC ||
            (function validateDocumentPositionWithFiberTree(
              ...
              if (documentPosition & Node.DOCUMENT_POSITION_CONTAINS) {
                if (null === otherFiber)
                  return (
                    otherNode === (otherFiber = otherNode.ownerDocument) ||
        ...
        (FragmentInstance.prototype.scrollIntoView = function (alignToTop) {
          ...
          if (0 === children.length) {
            var result = [null, null],
              parentHostFiber = getFragmentParentHostFiber(
                (children = this._fragmentFiber),
              )
            ...
            for (
              ...
              if (6 === (parentHostFiber = children[result]).tag) {
                var range = (parentHostFiber =
                  parentHostFiber.stateNode).ownerDocument.createRange()
              ...
              return (
                ...
                (styleProps = hoistableRoot.querySelector(
                  ...
                  ? ((resource.instance = styleProps),
                    ...
                    styleProps)
                  : ((instance = props),
                    (styleProps = preloadPropsMap.get(instance$268)) &&
      ...
      function insertStylesheet(instance, precedence, root) {
        ...
        prior
          ...
          : (precedence = 9 === root.nodeType ? root.head : root).insertBefore(
              instance,
      ...
      function onUnsuspend() {
        ;(this.count--, checkIfFullyUnsuspended(this))
      }
      function onUnsuspendImg() {
        ;(this.imgCount--, checkIfFullyUnsuspended(this))
      }
      ...
      function attemptHydrationAtCurrentPriority(fiber) {
        if (13 === fiber.tag || 31 === fiber.tag) {
          var lane = requestUpdateLane(),
            root = enqueueConcurrentRenderForLane(
              fiber,
            ...
            if (13 === (targetInst = nearestMounted.tag)) {
              if (
                ...
                return (
                  ...
                  void runWithPriority(queuedTarget.priority, function () {
      ...
      function retryIfBlockedOn(unblocked) {
        ...
        if (
          null != (i = (unblocked.ownerDocument || unblocked).$$reactFormReplay)
        )
      ...
      ReactDOMSharedInternals.findDOMNode = function (componentOrElement) {
        ...
        return (
          (componentOrElement = (function findCurrentFiberUsingSlowPath(fiber) {
            var alternate = fiber.alternate
            if (!alternate) {
    ...
    './node_modules/.pnpm/next@16.2.1_@babel+core@7.29.0_react-dom@19.2.4_react@19.2.4__react@19.2.4/node_modules/next/dist/compiled/scheduler/cjs/scheduler.production.js'(
      __unused_webpack_module,
      exports,
      __webpack_require__,
    ) {
